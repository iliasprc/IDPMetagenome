...
# 'Y']
# print(len(classes))
# # names,annotations,proteins,classes,w2i = read_data_(
# '/home/iliask/PycharmProjects/MScThesis/data/CAID_data_2018/fasta_files/data_disprot-disorder.txt')
# #names,annotations,proteins,classes,w2i = read_data_(
# '/home/iliask/PycharmProjects/MScThesis/data/idp_seq_2_seq/mxd494/MXD494.txt')
# # import torch
# # for i in range(len(names)):
# #
# #     print(names[i],'\n',proteins[i],'\n',annotations[i])
