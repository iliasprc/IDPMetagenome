...
from idp_methods.utils import seg_predictions, read_disprot, cast_metrics, iupred2a_metrics
...
def arguments():
    ...
    parser.add_argument('--dataset_name', type=str, default="input", help='dataset name',
                        choices=(
                        'SwissProt', 'DisProt', 'testdata_path', 'CAID2018', 'MXD494', 'disorder723', 'dm', 'input'))
...
if args.dataset_name == 'SwissProt':
    ...
    method_args.insert(1, dm)
else:
    method_args.insert(1, args.input)
...
if args.run_metrics:
    if args.method == 'cast':
        ...
        if args.dataset_name == 'SwissProt':
            #    idp_count = post_process_seg_output(results_file,ground_truth)
            annotations = read_disprot(ground_truth)
            seg_predictions(results_file, annotations)
        elif args.dataset_name == 'MXD494':
            # annotations = read_disprot('/home/iliask/PycharmProjects/MScThesis/data/idp_seq_2_seq/mxd494/annot_MXD494
            # .txt')
            ground_truth = '/home/iliask/PycharmProjects/MScThesis/data/idp_seq_2_seq/mxd494/annot_MXD494.txt'
