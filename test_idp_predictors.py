...
train_dataset = np.load('/home/iliask/PycharmProjects/MScThesis/results/mobidb/mxd494_train.npy',
                        allow_pickle=True).item()

val_dataset = np.load('/home/iliask/PycharmProjects/MScThesis/results/mobidb/mxd494_val.npy', allow_pickle=True).item()
